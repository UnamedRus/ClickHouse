...
TEST(PostingListCursorTest, TextIndexHeaderPersistsCodecType)
{
    ...
    WriteBufferFromOwnString out;
    TextIndexSerialization::serializeHeader(sparse_index, IPostingListCodec::Type::Bitpacking, static_cast<MergeTreeIndexVersion>(TextIndexHeader::Version::WithCodec), /*has_positions=*/ false, /*map_element=*/ false, /*map_stride=*/ 0, out);
